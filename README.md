...
jobs:
  buf:
    ...
    steps:
      ...
      - uses: step-security/buf-action@v1
        with:
...
If you have any feedback or need support, please create a issue here [GitHub Issues](https://github.com/step-security/buf-action/issues).
...
[buf]: https://buf.build
[buf-setup]: https://github.com/step-security/buf-setup-action
